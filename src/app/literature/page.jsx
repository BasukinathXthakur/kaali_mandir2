      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Bhagavad Gita */}
            <Link href="/literature/bhagavad-gita" className="group block">
            ...
            {/* Ramayana */}
            <Link href="/literature/ramayana" className="group block">
            ...
            {/* Mahabharata */}
            <Link href="/literature/mahabharat" className="group block">
